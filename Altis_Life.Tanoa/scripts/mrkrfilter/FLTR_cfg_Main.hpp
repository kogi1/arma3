class markerGroups
{
		...
		class Krankenhaus
	{
		...
		mrkrNames[] = {"hospital_3","hospital_2","hospital_georgetown"};
		mrkrTypes[] = {};
		mrkrTypeColors[] = {};
		side = "Default";
	};
	...
	class lfelder
	{
		displayName = "Legale Felder/Minen";
		mrkrNames[] = {
			"apple_3",
			"peaches_2",
			"apple_1",
