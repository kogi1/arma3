#define SAFETY_ZONES    [["civ_spawn_1", 100], ["Rebelop", 200], ["civ_spawn_4", 100]]
    ...
    _zone3 = getMarkerPos "civ_spawn_4"; // <-- HIER EURE SAFE_ZONE NAMEN REIN !!!
    _dis3 = 100;//Unterschiedliche Distanz der Einzelnen Safezones
