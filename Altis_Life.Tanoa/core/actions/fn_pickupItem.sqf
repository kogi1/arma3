...
if ((time - life_action_delay) < 2) exitWith {_huan = localize "STR_NOTF_ActionDelay"; [_huan,"red","slow"] call life_fnc_notify; INUSE(_this);};
...
if (_diff <= 0) exitWith {_huan = localize "STR_NOTF_InvFull"; [_huan,"red","slow"] call life_fnc_notify; INUSE(_this);};
