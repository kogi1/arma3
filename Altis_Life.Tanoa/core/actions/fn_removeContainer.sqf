...
if (!(_house in life_vehicles)) exitWith {_huan = localize "STR_ISTR_Box_NotinHouse"; [_huan,"red","slow"] call life_fnc_notify;};
...
if (_action) then {
    ...
    if (_diff isEqualTo 0) exitWith {_huan = localize "STR_NOTF_InvFull"; [_huan,"red","slow"] call life_fnc_notify;};
