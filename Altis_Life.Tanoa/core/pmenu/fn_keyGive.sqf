...
if ((lbCurSel 2702) isEqualTo -1) exitWith {_huan = localize "STR_NOTF_didNotSelectPlayer";[_huan,"red","slow"] call life_fnc_notify;};
...
_huan = format [localize "STR_NOTF_givenKeysTo",_unit getVariable ["realname",name _unit],typeOf _vehicle];
