...
*/
private ["_spikeStrip"];
if (!isNil "life_action_spikeStripPickup") exitWith {_huan = localize "STR_ISTR_SpikesDeployment"; [_huan,"red","slow"] call life_fnc_notify;};    // avoid conflicts with addactions allowing duplication.
