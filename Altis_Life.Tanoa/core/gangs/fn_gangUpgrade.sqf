...
if (_action) then {
    ...
    _huan = parseText format [localize "STR_GNOTF_UpgradeSuccess",_maxMembers,_slotUpgrade,[_upgradePrice] call life_fnc_numberText];
    ...
    _huan = localize "STR_GNOTF_UpgradeCancel";
	[_huan,"red","slow"] call life_fnc_notify;
};
