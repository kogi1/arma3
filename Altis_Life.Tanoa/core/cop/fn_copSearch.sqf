...
if (!alive _civ || player distance _civ > 5) exitWith {_huan = format [localize "STR_Cop_CouldntSearch",_civ getVariable ["realname",name _civ]]; [_huan,"red","slow"] call life_fnc_notify;};
//hint format ["%1",_this];
